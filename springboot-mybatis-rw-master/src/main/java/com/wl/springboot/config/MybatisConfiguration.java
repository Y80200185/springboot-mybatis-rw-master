...
import com.wl.springboot.util.SpringContextUtil;
import com.github.pagehelper.PageHelper;

@Configuration
//@AutoConfigureAfter(DataSourceConfiguration.class)
@MapperScan(basePackages="com.wl.springboot.dao")
...
//            sessionFactoryBean.setDataSource(roundRobinDataSouce);
            ...
            //java.sql.Driver
            // 读取配置 
            sessionFactoryBean.setTypeAliasesPackage("com.wl.springboot.domain");
         ...
         //设置mybatis-config.xml配置文件位置
            ...
            //添加分页插件、打印sql插件
            Interceptor[] plugins = new Interceptor[]{pageHelper(),new RWPlugin(), new SqlPrintInterceptor()};
...
//                System.err.println("使用数据库read-"+(lookupKey+1));
                return DataSourceType.write.getType();//+(lookupKey+1);
        	}
        };
