...
//
//import com.wl.springboot.annotation.ReadDataSource;
...
//
//
//	public void wirteAndReadPlug(User u){
//		userMapper.insert(u);
//		User uu = userMapper.findById(u.getId());
//		System.out.println("刚刚插入的=id="+u.getId()+",  user_name=" + uu.getUserName());
//		User uuu = userMapper.findById("1");
//		System.out.println("测试中的读====id=1,  user_name=" + uuu.getUserName());
//	}
//
//
//	@ReadDataSource
